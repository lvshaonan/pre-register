    ...
    <transition name="fadea">
        <div class="confirm-msg">
            ...
            <ul class="msg-box">
                <li>
                    <span>身份证有效期：</span>
                    <input type="text" v-model="idCardEndTime">
                </li>
                <li></li>
                <li>
...
export default {
  ...
  mounted() {
    // this.cardVal.idCardEndTime = this.idCardEndTime;
  },
  props: {
    idCardEndTime: {
        type: String,
  ...
  methods: {
    sendFather() {
        this.cardVal.idCardEndTime = this.idCardEndTime;
        this.$emit('idCardRe', this.cardVal);
    },
    close() {
        this.$emit('clossRe', this.cardVal.thisShow);
    }
  }
}
</script>
